...
class Cache extends BaseConfig
{
     ...
     *
     * 'apcu' is an in-process shared-memory cache (sub-ms, no file I/O or lock
     * contention) for the storefront facet hot-path. When the apcu extension is not
     * loaded (e.g. this CLI/dev SAPI), CI4 transparently falls back to $backupHandler
     * ('file'). Correctness holds across the apcu/file split because the durable
     * source of truth is the category_facet_summary table, which the read path reloads
     * from on staleness (see App\Libraries\Store\FacetCache::read()).
     */
