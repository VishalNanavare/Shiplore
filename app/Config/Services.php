...
class Services extends BaseService
{
    ...
    public static function manufacturerDeliveryRepository($getShared = true)
    {
        return $getShared ? static::getSharedInstance('manufacturerDeliveryRepository') : new \App\Models\ManufacturerDeliveryRepository();
    }

    public static function manufacturerSettlementService($getShared = true)
    {
        return $getShared ? static::getSharedInstance('manufacturerSettlementService') : new \App\Libraries\Manufacturer\ManufacturerSettlementService();
    }

    public static function b2bPolicy($getShared = true)
    {
        return $getShared ? static::getSharedInstance('b2bPolicy') : new \App\Libraries\Manufacturer\B2bPolicy();
    }

    public static function manufacturerPosReturnRepository($getShared = true)
    {
        return $getShared ? static::getSharedInstance('manufacturerPosReturnRepository') : new \App\Models\ManufacturerPosReturnRepository();
    }

    public static function manufacturerComboRepository($getShared = true)
    {
        return $getShared ? static::getSharedInstance('manufacturerComboRepository') : new \App\Models\ManufacturerComboRepository();
    }

    public static function manufacturerTransferRepository($getShared = true)
    {
        return $getShared ? static::getSharedInstance('manufacturerTransferRepository') : new \App\Models\ManufacturerTransferRepository();
    }
