...
class __TwigTemplate_7674075f9432a2eb79d15bebc32cfb81 extends Template
{
    private $source;
    private $macros = [];
...
yield _gettext("Export the data of all tables.");
  ...
  ";
    ...
    {
        return new Source("", "database/export/index.twig", "/opt/homebrew/var/www/pma/templates/database/export/index.twig");
    }
}
