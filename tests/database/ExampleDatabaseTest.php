...
final class ExampleDatabaseTest extends CIUnitTestCase
{
    ...
    {
        // Framework scaffold test: the tests DB group uses the SQLite3 driver.
        if (! extension_loaded('sqlite3')) {
            $this->markTestSkipped('sqlite3 extension not loaded; skipping framework scaffold DB test.');
        }
        parent::setUp();
    }
